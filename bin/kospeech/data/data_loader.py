...
class SpectrogramDataset(Dataset, SpectrogramParser):
    ...
    def shuffle(self):
        """ Shuffle dataset """
        print("섞는 중", len(self.audio_paths), len(self.transcripts), len(self.augment_methods))
...
def split_dataset(config: DictConfig, transcripts_path: str, vocab: Vocabulary):
    ...
    print(total_time_step, config.train.batch_size)
    ...
    for idx in range(config.train.num_workers):
        ...
        print(config.audio.transform_method, config.audio.audio_extension)
